...
export default {
  ...
  methods:{
        ...
        goPay(index){
            this.options.name = this.list[index].productName
            this.options.price = this.list[index].price
            this.options.productSpecsCode = this.list[index].productSpecsCode
            this.options.quantity = this.list[index].quantity
