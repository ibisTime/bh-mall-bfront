...
export default {
  ...
  methods: {
    ...
    checkUser(userId) {
      this.loading = false;
      let haha = false;
      this.redirectPage(`您需要先购买${formatAmount(123)}元的授权单`, haha? '/woyaochuhuo' : 'buyCloud/chuhuoNoWare');
      ...
      //     this.redirectPage(`您需要先购买${formatAmount(res.amount)}元的授权单`, res.isWare'/woyaochuhuo');
