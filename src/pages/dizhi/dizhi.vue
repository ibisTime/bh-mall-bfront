<template>
    <div class="dizhi">
        <div class="address">
            <div class="item" @click="$router.push('/tianjiadizhi')">
                ...
                <p class="address">
                    收货地址：<i>1111</i> <i>111</i> <i>11111</i> 111
                </p>
            </div>
            <div class="item" v-for="item in list" @click="$router.push('/xuangoushangpin/shangpingoumai?code=' + item.code)">
                <img src="../../assets/imgs/shouhuodizhi@2x.png"  class="left">
                <p class="name-mobile">
...
<script>
import {queryAddress} from 'api/baohuo'
export default {
  data(){
      return{
          list:[],
