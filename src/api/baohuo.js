...
//627251_代理申请
export function _replyAgent(options) {
    return fetch(627250, {
        address:options.address,
        area:options.district,
        city:options.city,
...
//登录
export function usergo(code,userReferee) {
    return fetch(627301, {
        code:code,
...
//管理员查询
export function queryManager(userId) {
    return fetch(627045, {
        limit:100,
        start:0,
    });
...
//分页查询待处理订单
export function queryOrderForm(status) {
    return fetch(627665, {
        start:0,
        limit:100,
        toUserId:getUserId(),
...
//查询默认地址
export function queryDefaultAddress(code) {
    return fetch(627411, {
        isDefault:1,
        userId:getUserId(),
    });
